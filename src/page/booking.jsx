  ...
  return (
    <>
      ...
      <div className="relative main-content top-24 px-14 mb-36">
        ...
        {/* Ratings */}
        <div className="relative w-full max-w-7xl mx-auto flex flex-col items-center mb-10 mt-16">
          <img
        ...
        <div>
          ...
          <p className="text-gray-700">
            Halo! Saya Jovis Jocunda, seorang teknisi perangkat lunak yang
            berdedikasi dengan semangat untuk menyelesaikan tantangan teknis
            yang kompleks. Dengan pengalaman bertahun-tahun di industri ini,
            saya telah mengasah keterampilan saya dalam mendiagnosis dan
            menyelesaikan masalah perangkat lunak dengan presisi dan efisiensi.
            Komitmen saya untuk tetap terupdate dengan perkembangan teknologi
            terbaru memastikan bahwa saya memberikan solusi terkini kepada
            klien-klien saya. Baik itu memecahkan masalah bug perangkat lunak,
            mengoptimalkan kinerja sistem, atau memberikan panduan ahli, saya di
            sini untuk memberikan dukungan teknis terbaik yang disesuaikan
