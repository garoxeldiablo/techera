      ...
      <div class="w-full bg-white flex items-center justify-center">
        <div data-aos="fade-up" class="max-w-md w-full p-6">
            ...
            <div className="text-center">
              ...
              <h1 class="text-md font-semibold mb-6 text-gray-500 text-center">Buat Akun Anda</h1>
            </div>
          <form action="#" method="POST" class="space-y-4">
            <div>
              <label for="username" class="block text-sm font-medium text-gray-700">Nama Pengguna</label>
              <input type="text" id="username" name="username" class="italic mt-1 p-2 w-full border rounded-md focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300" placeholder='buat nama pengguna anda'/>
            </div>
            <div>
              <label for="email" class="block text-sm font-medium text-gray-700">Email</label>
              <input type="text" id="email" name="email" class="italic mt-1 p-2 w-full border rounded-md focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300" placeholder='masukkan email anda'/>
            </div>
            <div>
              <label for="password" class="block text-sm font-medium text-gray-700">Kata Sandi</label>
              <input type="password" id="password" name="password" class="italic mt-1 p-2 w-full border rounded-md focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300" placeholder='buat kata sandi anda'/>
              <p
            ...
            <div>
              <button type="submit" class="w-full bg-blue-700 text-white p-2 rounded-md hover:bg-gray-800 focus:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors duration-300">Buat Akun</button>
            </div>
          ...
          <div class="mt-4 text-sm text-gray-600 text-center">
            <p>Sudah punya akun? <button onClick={()=>navigate('/signin')} class="text-black hover:underline">Masuk di sini</button>
            </p>
          </div>
        </div>
      </div>
