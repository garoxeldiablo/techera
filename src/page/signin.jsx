      ...
      <div className="w-full bg-white flex items-center justify-center">
        <div data-aos="fade-up" className="max-w-md w-full p-6">
            ...
            <div className="text-center">
              ...
              <h1 className="text-md font-semibold mb-6 text-gray-500 text-center">Login to your account</h1>
            </div>
          ...
          <form onSubmit={handleSubmitEvent} method="POST" className="space-y-4">
            ...
            <div>
              ...
              <input onChange={handleInput} type="text" id="email" name="email" className="italic mt-1 p-2 w-full border rounded-md focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300" placeholder='shaela@example.com'/>
            </div>

            <div>
              <label htmlFor="password" className="block text-sm font-medium text-gray-700">Password</label>
              <input onChange={handleInput} type="password" id="password" name="password" className="italic mt-1 p-2 w-full border rounded-md focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300" placeholder='enter your password'/>
            </div>

            <div>
              <button onClick={()=> navigate('/clientarea')} type="submit" className="w-full bg-blue-700 text-white p-2 rounded-md hover:bg-gray-800 focus:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors duration-300">Login</button>
            </div>
            ...
            <div className="w-full lg:w-1/2 ml-0 lg:ml-2">
              <button type="button" className="w-full flex justify-center items-center gap-2 bg-white text-sm text-gray-600 p-2 rounded-md hover:bg-gray-50 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-200 transition-colors duration-300">
                ...
                </svg> SignIn with Github </button>
            </div>
          </div>
          </form>

          <div className="mt-4 text-sm text-gray-600 text-center">
            <p>No have an account? <button onClick={()=>navigate('/signup')} className="text-black hover:underline">create account</button>
            </p>
          </div>
        </div>
      </div>
