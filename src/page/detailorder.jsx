...
export default function DetailOrder() {
  ...
  return (
    <>
      <div className="relative main-content md:px-14 px-4 pt-24">
        ...
        <div className="md:flex">
          <div className="md:w-1/2 m-6">
            ...
            <button
              className="my-2 md:ml-2 md:mt-8 px-3 py-2 text-base font-medium text-center text-white transition duration-500 ease-in-out transform bg-blue-600 lg:px-6 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
      ...
      <Payment isOpen={isPaymentModalOpen} onClose={closePaymentModal} onPaymentSuccess={openSuccessModal} />
      <SuccessModal isOpen={isSuccessModalOpen} onClose={closeSuccessModal} />  {/* Include the success modal */}
      <Footer />
    </>
  );
}
