...
export default function CardTechnician(){
    return(
        ...
        {/* <div class="flex flex-col items-center bg-white border rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100">
            <img class="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-s-lg" src="../src/assets/technician/a.jpg" alt=""/>
            <div class="flex flex-col justify-between p-4 leading-normal">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-800 ">Agus Bisana</h5>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Hardware</p>
                <Rating>
                <RatingStar />
                <RatingStar />
                <RatingStar />
